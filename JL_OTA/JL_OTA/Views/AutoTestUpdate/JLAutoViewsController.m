...
@implementation JLAutoViewsController


+ (UITabBarController *)prepareViewControllers {
    AutoUpdateViewController *vc_1 = [AutoUpdateViewController new];
    AutoDevicesViewController *vc_2 = [[AutoDevicesViewController alloc] init];
    AutoSettingViewController *vc_3 = [AutoSettingViewController new];
