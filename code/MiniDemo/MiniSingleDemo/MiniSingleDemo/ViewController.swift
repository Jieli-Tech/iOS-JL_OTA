...
class ViewController: UIViewController {
    ...
    func setupBind(){
        BleManager.shared.discoverPeripheralsSubject.bind(to: subTableView.rx.items(cellIdentifier: "cell")) { _, peripheral, cell in
            ...
            if peripheral.identifier.uuidString == BleManager.shared.currentPeripheral?.identifier.uuidString {
    ...
    func bindAction(){
        ...
        subTableView.rx.modelSelected(CBPeripheral.self).subscribe(onNext: { peripheral in
